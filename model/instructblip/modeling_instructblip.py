...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def stage2_setting(self):
        ...
        self.language_model = get_peft_model(self.language_model, lora_config).to(dtype=torch.bfloat16)
    ...
    def forward(
            ...
            sp_token: Optional[int] = 32100, # 32110 # flant5-- 32100; vicuna-- 32001
            return_logits_only: Optional[bool] = False
    ) -> Union[Tuple, InstructBlipForConditionalGenerationModelOutput]:
        r"""
        Returns:
        ...
        if self.config.use_decoder_only_language_model:
            outputs = self.language_model(
                inputs_embeds=inputs_embeds.to(self.language_model.device),
